    ...
    public static function config(Typecho_Widget_Helper_Form $form){
		...
		$divstr1='
			...
			<span>
				...
				<pre><font color="blue">第一人gif图片地址`{number}`第一人英文名`第一人中文名`第一人说话内容|第二人gif图片地址`{number}`第二人英文名`第二人中文名`第二人说话内容</font>……以此类推<br />1、每个对话之间用“<font color="red">|</font>”分割，对话中每个项目用“<font color="red">`</font>”分割。<br />2、{number}位置填写0、1、3、4，0代表普通女声、1代表普通男声、3代表情感男声、4代表情感女声。<br />3、注意同一文章中每个英文名不能相同。
				</pre>
			</span>
						...
						$out.='
							<div class="am-modal am-modal-alert my-alert" tabindex="-1" id="my-alert'.$index.'">
							  <div class="am-modal-dialog">
								<div class="am-modal-hd"><img src="'.$values[0].'" /></div>
